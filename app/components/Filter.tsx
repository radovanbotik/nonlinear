    ...
    <div className="">
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-6 //pt-24">
            <div>
              <span className=" text-4xl font-bold tracking-tight text-gray-900">{headline}</span>
            </div>
          ...
          <section aria-labelledby="categories" className="pb-24 pt-6">
                  ...
                  <fieldset>
                    <ul className="space-y-4">
                      {radioFilters.map(radioFilter => (
                        <li key={radioFilter.id} className="space-y-2">
                          <h3 className="-my-3 flow-root">
                            <DisclosureButton className="group flex w-full items-center justify-between  py-3 text-sm text-gray-400 hover:text-gray-500">
                              ...
                              <span className="ml-6 flex items-center">
                                <RiAddFill aria-hidden="true" className="h-5 w-5 group-data-[open]:hidden" />
                                <RiSubtractFill
                                  aria-hidden="true"
                          ...
                          <DisclosurePanel className={"space-y-2"}>
                            {radioFilter.options.map(formatOption => (
                              <div key={formatOption.value} className="relative flex items-center">
                                <input
                                  ...
                                  onClick={e => handleSearch(radioFilter.id, e.target.value)}
